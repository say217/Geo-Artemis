...
def build_date_range(years_back=5):
...
if __name__ == "__main__":
    ...
    # Fetch and parse data (past 5 years)
    start_date, end_date = build_date_range(years_back=5)
    data = fetch_earthquake_data(URL, start_date, end_date)
    df = parse_data(data)

    # Save to USGS_DATA folder
    output_file = os.path.join(output_dir, "earthquakes_5_years.csv")
